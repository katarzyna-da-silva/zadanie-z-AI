  ...
  try {
    const response = await openai.chat.completions.create({
      ...
      messages: [{
        role: 'user',
        content:
            `Please convert the following article into HTML code. It should include headings, paragraphs, and proper HTML structure:
...
// Czytanie z pliku text.txt i przeksztalcenie go w kod. Zapis w nowym pliku artykul.html 
    fs.writeFile(
        '/home/z390/Bureau/zadanie/artykul.html', outputHtml, (err) => {
          if (err) {
